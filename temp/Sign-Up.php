...
<div class="container">
  <form action="Sign-Up.php" method="post">
    <div class="row">
      ...
      <div class="input-group input-group-icon">
        <input type="email" placeholder="Contact Number" name="txtContact" id="txtContact"/>
        <div class="input-icon"><i class="fa fa-mobile"></i></div>
      </div>

       <div class="acctype-chkbox">
            <input type="checkbox" name="chkAdmin" id="chkAdmin" />
            <label for="chkAdmin">Admin
            <input type="checkbox" name="chkCustomer" id="chkCustomer" />
            <label for="chkCustomer">Customer
      </div>
    </div>
    <div class="row">
      <div class="col-half">
